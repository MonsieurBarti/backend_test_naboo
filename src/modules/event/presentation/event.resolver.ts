...
import { EventNotFoundError, InvalidRecurrencePatternError } from '../domain/errors/event-base.error';
 ...
 */
function parseRecurrencePatternInput(input: RecurrencePatternInput, correlationId: string): RecurrencePatternProps {
...
export class EventResolver {
	...
	async createEvent(@Args('input') input: CreateEventInput): Promise<typeof CreateEventResult> {
		...
		try {
			const recurrencePattern = input.recurrencePattern
